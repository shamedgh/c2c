...
#define CONFIGURE_ARGS " 'CXX=clang++' 'CC=clang' 'LD=/usr/bin/ld' 'CFLAGS=-flto -O0' 'LDFLAGS=-flto -Wl,-plugin-opt=save-temps'"
...
#define PG_VERSION_STR "PostgreSQL 13.4 on x86_64-pc-linux-gnu, compiled by clang version 12.0.0, 64-bit"
