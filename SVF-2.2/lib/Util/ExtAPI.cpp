...
//    {"_ZSt18_Rb_tree_decrementPSt18_Rb_tree_node_base", ExtAPI::EFT_STD_RB_TREE_INCREMENT},
    ...
    /// added by Hamed for alloc wrappers
    {"ngx_alloc", ExtAPI::INT_ALLOC},
    {"ngx_calloc", ExtAPI::INT_ALLOC},
    {"ngx_pcalloc", ExtAPI::INT_ALLOC},
    {"ngx_palloc", ExtAPI::INT_ALLOC},
    {"ngx_palloc_small", ExtAPI::INT_ALLOC},
    {"ngx_palloc_block", ExtAPI::INT_ALLOC},
    {"ngx_palloc_large", ExtAPI::INT_ALLOC},
    {"ngx_pnalloc", ExtAPI::INT_ALLOC},
    {"ngx_memalign", ExtAPI::INT_ALLOC},
    {"ngx_pmemalign", ExtAPI::INT_ALLOC},
